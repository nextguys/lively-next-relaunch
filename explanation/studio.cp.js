...
<figure data-type=\"image\"><img src=\"./assets/lively-desktop.png\" alt=\"\" style=\"max-width:800px\"><figcaption>A <code>lively.next</code> instance showcasing various tools.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/halo-mode.png\" alt=\"\" style=\"max-width:200px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/summon-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Depiction of a halo getting summoned on a morph.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/propagate-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>The halo selection can be propagated up a morph’s owner chain.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/hover-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Selection targets are displayed when in Halo mode.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/resize-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Resizing an object via the halo.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/rename-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Changing the name of an object.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/rotate-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Rotating via halo</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/scale-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Scaling via halo</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/component_halo.png\" alt=\"\" style=\"max-width:80px\"><figcaption>The “component” halo</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/copy-halo.gif\" alt=\"\" style=\"max-width:200px\"><figcaption>Copying a morph via the halo.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/menu_halo.png\" alt=\"\" style=\"max-width:80px\"><figcaption>The menu halo</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/drag-halo.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>Dragging a morph via the halo handle.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/grab-halo.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>Grabbing a morph via the halo handle.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/remove-halo.gif\" alt=\"\" style=\"max-width:300px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/inspector_halo.png\" alt=\"\" style=\"max-width:80px\"><figcaption>The inspector halo</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/text-mode.png\" alt=\"\" style=\"max-width:200px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/shape-mode.png\" alt=\"\" style=\"max-width:200px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/asset-button.png\" alt=\"\" style=\"max-width:200px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/asset_browser_open.png\" alt=\"\" style=\"max-width:400px\"><figcaption>An opened Asset Browser, including the assets for this website.</figcaption></figure>\n\
<h3 class=\"markdown-line-marker\" data-mdline=\"154\" data-htmlline=\"155\">Component Browser</h3>\n\
<figure data-type=\"image\"><img src=\"./assets/component-button.png\" alt=\"\" style=\"max-width:200px\"><figcaption>The button to open the Component Browser in the top bar.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/component_browser_open.png\" alt=\"\" style=\"max-width:400px\"><figcaption>An opened Component Browser, showing the component that is this website.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/mini-map-button.png\" alt=\"\" style=\"max-width:200px\"><figcaption>The button that shows/closes the minimap and allows to enable “canvas mode”</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/zoom_indicator.png\" alt=\"\" style=\"max-width:300px\"><figcaption>The zoom indicator, at the side of an opened minimap, showing a zoom value when zoomed in.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/justin_user_flap.png\" alt=\"\" style=\"max-width:200px\"><figcaption>Even Robins dog is using <code>lively.next</code>!</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/up-to-date.png\" alt=\"\" style=\"max-width:170px\"></figure>\n\
<ul>\n\
...
<figure data-type=\"image\"><img src=\"./assets/update.png\" alt=\"\" style=\"max-width:200px\"></figure>\n\
<ul>\n\
...
<figure data-type=\"image\"><img src=\"./assets/ahead.png\" alt=\"\" style=\"max-width:170px\"></figure>\n\
<ul>\n\
...
<figure data-type=\"image\"><img src=\"./assets/out-of-sync.png\" alt=\"\" style=\"max-width:260px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/shape_control.png\" alt=\"\" style=\"max-width:400px\"><figcaption>The Shape Control Widget</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/rich_text_controls.png\" alt=\"\" style=\"max-width:400px\"><figcaption>The Rich Text Widget</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/font_manager.png\" alt=\"\" style=\"max-width:800px\"><figcaption>The Rich Text Widget with an opened Font Manager</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/rich_text_popup.png\" alt=\"\" style=\"max-width:400px\"><figcaption>The Rich Text Formatting Popup</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/fixed-default.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>A morph that has a fixed position in relation to the container left and top border.</figcaption></figure>\n\
<figure data-type=\"image\"><img src=\"./assets/fixed-bottom.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>A morph that has a fixed position in relation to the container right and bottom border.</figcaption></figure>\n\
<figure data-type=\"image\"><img src=\"./assets/fixed-top-bottom.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>A morph that has a fixed position in relation to the containers top <strong>and</strong> bottom border at the same time.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/centered.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>A Constraint Layout centering a morph.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/scale.gif\" alt=\"\" style=\"max-width:300px\"><figcaption>A Constraint Layout resizing a morph in relation to its container.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/item-axis.gif\" alt=\"\" style=\"max-width:300px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/item-spacing.gif\" alt=\"\" style=\"max-width:300px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/wrap-items.gif\" alt=\"\" style=\"max-width:300px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/align-axis.gif\" alt=\"\" style=\"max-width:300px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/axis-spacing.gif\" alt=\"\" style=\"max-width:300px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/advanced_stroke.png\" alt=\"\" style=\"max-width:400px\"><figcaption>The advanced border control popup.</figcaption></figure>\n\
<h3 class=\"markdown-line-marker\" data-mdline=\"376\" data-htmlline=\"377\">Component Control</h3>\n\
<figure data-type=\"image\"><img src=\"./assets/component_controls.png\" alt=\"\" style=\"max-width:400px\"><figcaption>The component controls without any master components specified on the target.</figcaption></figure>\n\
...
<p class=\"responsive-video markdown-line-marker\" data-mdline=\"395\" data-htmlline=\"396\"><video src=\"./assets/responsive_halo.mp4\" controls=\"\" class=\"html5-video-player\">\n\
Your browser does not support playing HTML5 video.\n\
You can <a href=\"./assets/responsive_halo.mp4\" download=\"\">download the file</a> instead.\n\
...
<figure data-type=\"image\"><img src=\"./assets/scene_graph.png\" alt=\"\" style=\"max-width:400px\"><figcaption>Partial “Scene Graph” for the design of this webiste.</figcaption></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/system_browser.png\" alt=\"\" style=\"max-width:600px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/search.png\" alt=\"\" style=\"max-width:400px\"></figure>\n\
...
<figure data-type=\"image\"><img src=\"./assets/file_browser.png\" alt=\"\" style=\"max-width:400px\"><figcaption>The ‘File Browser’ browsing the contents of the project for this website.</figcaption></figure>\n\
...
<p class=\"responsive-video markdown-line-marker\" data-mdline=\"36\" data-htmlline=\"37\"><video src=\"./assets/workspace.mp4\" controls=\"\" class=\"html5-video-player\">\n\
Your browser does not support playing HTML5 video.\n\
You can <a href=\"./assets/workspace.mp4\" download=\"\">download the file</a> instead.\n\
...
<p class=\"responsive-video markdown-line-marker\" data-mdline=\"44\" data-htmlline=\"45\"><video src=\"./assets/shell_terminal.mp4\" controls=\"\" class=\"html5-video-player\">\n\
Your browser does not support playing HTML5 video.\n\
You can <a href=\"./assets/shell_terminal.mp4\" download=\"\">download the file</a> instead.\n\
