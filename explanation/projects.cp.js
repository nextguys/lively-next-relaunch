...
<p class=\"markdown-line-marker\" data-mdline=\"28\" data-htmlline=\"29\">The dropdown menu in the project creation prompt allows you to specify the owner of the projects repository on GitHub. You can either create the repository under your own user account or create it under an organization you are a member of.</p>\n\
...
<p class=\"markdown-line-marker\" data-mdline=\"34\" data-htmlline=\"35\">Working with <code>lively.next</code> projects is straight forward: Just open them inside of lively from the landing page and develop away! When you want to save your changes you can just press the save button in the top bar. <code>lively.next</code> will prompt you for a description of the changes you made. Clear and concise descriptions will make your life and that of all your collaborators easier. After you save your changes, they will also become available to all your collaborators.</p>\n\
...
<p class=\"markdown-line-marker\" data-mdline=\"52\" data-htmlline=\"53\">To add a different <code>lively.next</code> project to your project as a dependency, you simply use one of the components of the dependency inside of your <code>lively.next</code> project. The recommended way of doing this is via the “Component Browser”.</p>\n\
...
<h2 class=\"markdown-line-marker\" data-mdline=\"72\" data-htmlline=\"73\"><code>lively.project</code> internals - Informations for Developers</h2>\n\
