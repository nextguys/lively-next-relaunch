...
export const MediumNavBar = component(BaseNavBar, {
  submorphs: [{
    name: 'burger menu',
    visible: false
  }, {
...
export const NavBar = component(BaseNavBar, {
  ...
  // FIXME: the spaced menu items inline policy is not partitioned by the above master!
  extent: pt(878.5, 66.9),
  layout: new TilingLayout({
    align: 'center',
    axisAlign: 'center',
    padding: rect(20, 0, 0, 0),
    resizePolicies: [['spaced menu items', {
      height: 'fixed',
      width: 'fill'
    }]]
  }),
